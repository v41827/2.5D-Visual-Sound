...
class TestOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--test_text_path', required=True, help='path to the input text file')
		...
		self.parser.add_argument('--weights_text', type=str, default='', help="weights for text stream")
		self.parser.add_argument('--freeze_text', type=bool, default=True, help='freeze text encoder weights')
